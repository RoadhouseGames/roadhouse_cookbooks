...
attribute "mwt_portal/smtp_user",
          ...
          :description => "The SMTP account for the portal.",
          :required => "required",
          :recipes => ["mwt_portal::default"]

attribute "mwt_portal/smtp_password",
          :display_name => "SMTP Password",
          :description => "The SMTP password for the portal.",
          :required => "required",
          :recipes => ["mwt_portal::default"]
...
attribute "mwt_portal/cdn_storage_asset_folder",
          :display_name => "CDN Storage Asset Folder",
