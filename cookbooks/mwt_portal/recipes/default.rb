...
template "#{WWW_DOCUMENT_ROOT}/application/configs/application.php" do
  ...
  variables(
      ...
      :email_contact_account => node[:mwt_portal][:contact_email],
      :email_sender_account => node[:mwt_portal][:sender_email],
      :email_smtp_user => node[:mwt_portal][:smtp_user],
      :email_smtp_password => node[:mwt_portal][:smtp_password],
      ...
      :cdn_asset_fqdn => node[:mwt_portal][:cdn_fqdn],
      :cdn_asset_user_account => node[:mwt_portal][:cdn_user],
      :cdn_asset_user_password => node[:mwt_portal][:cdn_password],
      :cdn_asset_base_folder => node[:mwt_portal][:cdn_user_asset_folder],
      :cdn_storage_fqdn => node[:mwt_portal][:cdn_storage_fqdn],
      :cdn_storage_user_account => node[:mwt_portal][:cdn_storage_user],
      :cdn_storage_user_password => node[:mwt_portal][:cdn_storage_password],
      :cdn_storage_base_folder => node[:mwt_portal][:cdn_storage_asset_folder],
